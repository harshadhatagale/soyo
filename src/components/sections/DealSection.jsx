...
export default function DealSection() {
    return (
        <div className="lg:w-[80%] flex-col lg:flex-row space-x-5 h-28 py-2 lg:h-16 my-6 mx-auto border border-gray-200 flex justify-center items-center rounded-md">
